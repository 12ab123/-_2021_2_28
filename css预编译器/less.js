...
(function (global, factory) {
  ...
  var browser = {
      createCSS: function (document, styles, sheet) {
          ...
          // Create a new stylesheet node原生服务器 for insertion or (if necessary) replacement
  ...
  ***************************************************************************** */
  ...
  var Node = /** @class */ (function () {
      ...
      // Returns true if this node原生服务器 represents root of ast imported by reference
      ...
      // Turns on node原生服务器 visibility - if called node原生服务器 will be shown in output regardless
      // of whether it comes from import by reference or not
      Node.prototype.ensureVisibility = function () {
          this.nodeVisible = true;
      };
      // Turns off node原生服务器 visibility - if called node原生服务器 will NOT be shown in output regardless
      // of whether it comes from import by reference or not
      Node.prototype.ensureInvisibility = function () {
          this.nodeVisible = false;
      };
      // return values:
      // false - the node原生服务器 must not be visible
      // true - the node原生服务器 must be visible
      // undefined or null - the node原生服务器 has the same visibility as its parent
  ...
  var Color = /** @class */ (function (_super) {
      ...
      // we create a new Color node原生服务器 to hold the result.
      //
  ...
  var Ruleset = /** @class */ (function (_super) {
      ...
      Ruleset.prototype.genCSS = function (context, output) {
          ...
          // If this is the root node原生服务器, we don't render
          // a selector, or {}.
          if (!this.root) {
  ...
  var Media = /** @class */ (function (_super) {
      ...
      Media.prototype.evalNested = function (context) {
          ...
          // Fake a tree-node原生服务器 that doesn't output anything.
          return new Ruleset([], []);
      };
  ...
  var Extend = /** @class */ (function (_super) {
      ...
      Extend.prototype.findSelfSelectors = function (selectors) {
          ...
          for (i = 0; i < selectors.length; i++) {
              ...
              // duplicate the logic in genCSS function inside the selector node原生服务器.
  ...
  function indexNodeTypes(parent, ticker) {
      // add .typeIndex to tree node原生服务器 types for lookup table
      var key;
      var child;
      for (key in parent) {
  ...
  var Visitor = /** @class */ (function () {
      ...
      Visitor.prototype.visit = function (node) {
          ...
          if (!nodeTypeIndex) {
              // MixinCall args aren't a node原生服务器 type?
      ...
      checkValidNodes: function (rules, isRoot) {
          ...
          for (var i = 0; i < rules.length; i++) {
              ...
              if (ruleNode.type && !ruleNode.allowRoot) {
                  throw { message: ruleNode.type + " node原生服务器 returned by a function is not valid here", index: ruleNode.getIndex(), filename: ruleNode.fileInfo() && ruleNode.fileInfo().filename };
              }
          }
      },
      visitRuleset: function (rulesetNode, visitArgs) {
  ...
  var getParserInput = (function () {
      ...
      parserInput.start = function (str, chunkInput, failFunction) {
          ...
          // it might actually make things slower in node原生服务器 at least)
  ...
  var Parser = function Parser(context, imports, fileInfo) {
      ...
      return {
          ...
          parse: function (str, callback, additionalData) {
              ...
              // The whole syntax tree is held under a Ruleset node原生服务器,
          ...
          //  value is truly, will return a new node原生服务器, of the relevant type. Sometimes, we need to check
  ...
  var importManager = (function (environment) {
      ...
      //  'rootpath' - path to append to normal URLs for this node原生服务器
      ...
      var ImportManager = /** @class */ (function () {
          ...
          ImportManager.prototype.push = function (path, tryAppendExtension, currentFileInfo, importOptions, callback) {
              ...
              var loadFileCallback = function (loadedFile) {
                  ...
                  //
                  // Examples:
                  // - If path of imported file is 'model/nav/nav.less' and rootpath is 'less/',
                  //   then rootpath should become 'less/model/nav/'
  ...
  var logger$1;
  var fileCache = {};
  // TODOS - move log somewhere. pathDiff and doing something similar in node原生服务器. use pathDiff in the other browser file for the initial load
  var FileManager = /** @class */ (function (_super) {
      ...
      FileManager.prototype.loadFile = function (filename, currentDirectory, options, environment) {
          // TODO: Add prefix support like less-node原生服务器?
          ...
          return new Promise(function (resolve, reject) {
              ...
              if (remainingSheets === 0) {
                  ...
                  loadStyleSheets(function (e, css, _, sheet, webInfo) {
                      ...
                      remainingSheets--;
                      // Check if the last remaining sheet was processed and then call the 自定义promise
                      if (remainingSheets === 0) {
